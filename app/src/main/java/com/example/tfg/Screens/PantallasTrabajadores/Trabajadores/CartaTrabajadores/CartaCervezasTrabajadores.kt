...
@Composable
fun CartaCervezasTrabajadores(navController: NavHostController) {
                ...
                Button(
                    onClick = {
                        db.collection(coleccion)
                           /*lo que tengo que cambiar es lo que
                           * está entre comillas cada vez que
                           * cree una nueva pantalla*/ .add(hashMapOf("cerveza" to bebida))
